// assets/js/schedule_generator.js - Drag & Drop Schedule Generator (No AI)
...
const ScheduleGenerator = (function() {
    ...
    // ============================================
    function init() {
        console.log('ScheduleGenerator initializing...');
        initTimetable();
        loadRooms();
        loadDepartments();
        setupEventListeners();
    ...
    function renderDepartmentButtons() {
        ...
        $container.append(`
            <button class="dept-btn ${!selectedDepartment ? 'active' : ''}" onclick="ScheduleGenerator.selectDepartment(null)">
        ...
        departments.forEach(dept => {
            ...
            $container.append(`
                <button class="dept-btn ${activeClass}" onclick="ScheduleGenerator.selectDepartment(${dept.department_id})">
    ...
    function updateDepartmentUI(data) {
        ...
        data.sections.forEach(section => {
            $sectionButtons.append(`
                <button class="section-btn" onclick="ScheduleGenerator.showSectionSchedule('${section.section}')">
    ...
    function renderScheduleBlock($wrapper, schedule, left, width, height, deptClass) {
        ...
        const blockHtml = `
            <div class="schedule-block ${deptClass}" 
                ...
                <div class="schedule-delete" onclick="ScheduleGenerator.deleteSchedule(event, ${schedule.schedule_id})">
                    <i class="bi bi-x"></i>
                </div>
                <div class="schedule-edit" onclick="ScheduleGenerator.editSchedule(event, ${schedule.schedule_id})">
                ...
                $listContainer.append(`
                    <div class="unscheduled-class" draggable="true"
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button class="btn btn-sm btn-outline-success" onclick="ScheduleGenerator.scheduleUnscheduledClass(${cls.class_id})">
    ...
    function showRoomSelectionModal() {
        ...
        if (availableRooms.length === 0) {
            ...
            availableRooms.forEach(room => {
                contentHtml += `
                    <div class="room-card-selection" onclick="ScheduleGenerator.selectRoom(${room.room_id})" data-room-id="${room.room_id}">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
        ...
        let html = `
            ...
            <div class="table-responsive p-3">
                <table class="table table-sm table-hover">
                    <thead><th>Course</th><th>Name</th><th>Instructor</th><th>Day</th><th>Time</th><th>Room</th></tr></thead>
                    <tbody>
        `;
